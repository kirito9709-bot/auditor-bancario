...
def parsear_lineas_texto(text: str, origen: str) -> list:
    ...
    for line in lines:
        ...
        # Filtro estricto para ignorar totales e información financiera
        line_lower = line_clean.lower()
        if any(term in line_lower for term in IGNORE_TERMS) or line_lower.startswith("total"):
            continue
        ...
        for i, page in enumerate(pdf.pages, 1):
            ...
            for tbl in tables:
                for row in tbl:
                    ...
                    # Descartar renglones de resumen o cuadros financieros en tablas
                    if any(term in linea_str for term in IGNORE_TERMS) or linea_str.startswith("total"):
                        continue
